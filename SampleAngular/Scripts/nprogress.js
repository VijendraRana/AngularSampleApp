; (function (root, factory) {
        ...
        queue(function (next) {
            ...
            if (n === 1) {
                ...
                setTimeout(function () {
                    ...
                    setTimeout(function () { NProgress.remove(); next(); }, speed);
                }, speed);
    ...
    NProgress.start = function () {
        ...
        var work = function () {
            setTimeout(function () { if (!NProgress.status) return; NProgress.trickle(); work(); }, Settings.trickleSpeed);
        };
    ...
    var css = (function () {
        ...
        function camelCase(string) {
            return string.replace(/^-ms-/, 'ms-').replace(/-([\da-z])/gi, function (match, letter) { return letter.toUpperCase(); });
        }
